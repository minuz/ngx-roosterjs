...
const BOLD_SVG = require('../assets/icons/bold.svg');
const ITALIC_SVG = require('../assets/icons/italic.svg');
const UNDERLINE_SVG = require('../assets/icons/underline.svg');
const BULLETS_SVG = require('../assets/icons/bullets.svg');
const BULLETS_RTL_SVG = require('../assets/icons/bullets-rtl.svg');
const NUMBERING_SVG = require('../assets/icons/numbering.svg');
const NUMBERING_RTL_SVG = require('../assets/icons/numbering-rtl.svg');
const OUTDENT_SVG = require('../assets/icons/outdent.svg');
const OUTDENT_RTL_SVG = require('../assets/icons/outdent-rtl.svg');
const INDENT_SVG = require('../assets/icons/indent.svg');
const INDENT_RTL_SVG = require('../assets/icons/indent-rtl.svg');
const BLOCKQUOTE_SVG = require('../assets/icons/blockquote.svg');
const ALIGNLEFT_SVG = require('../assets/icons/alignleft.svg');
const ALIGNCENTER_SVG = require('../assets/icons/aligncenter.svg');
const ALIGNRIGHT_SVG = require('../assets/icons/alignright.svg');
const UNLINK_SVG = require('../assets/icons/unlink.svg');
const SUPERSCRIPT_SVG = require('../assets/icons/superscript.svg');
const SUBSCRIPT_SVG = require('../assets/icons/subscript.svg');
const STRIKETHROUGH_SVG = require('../assets/icons/strikethrough.svg');
const LTR_SVG = require('../assets/icons/ltr.svg');
const RTL_SVG = require('../assets/icons/rtl.svg');
const UNDO_SVG = require('../assets/icons/undo.svg');
const REDO_SVG = require('../assets/icons/redo.svg');
const REMOVEFORMAT_SVG = require('../assets/icons/removeformat.svg');
const DROPDOWN_SVG = require('../assets/icons/dropdown.svg');
const BACKCOLOR_SVG = require('../assets/icons/backcolor.svg');
const TEXTCOLOR_SVG = require('../assets/icons/textcolor.svg');
const CREATELINK_SVG = require('../assets/icons/createlink.svg');
const IMAGE_ALT_TEXT_SVG = require('../assets/icons/imagealttext.svg');
const FONTSIZE_SVG = require('../assets/icons/fontsize.svg');
const FONTNAME_SVG = require('../assets/icons/fontname.svg');
const EMOJI_SVG = require('../assets/icons/emoji.svg');

const buttonImages: Strings = {};
...
export default function ribbonButtonRenderer(buttonName: string, isRtl: boolean): JSX.Element {
  const image = buttonImages[isRtl ? buttonName + '-rtl' : buttonName];
